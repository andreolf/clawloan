  ...
  return (
    <>
      ...
      <div className="relative" data-wallet-menu>
        ...
        {showConnectors && (
          <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] max-w-[calc(100vw-2rem)] bg-[var(--card)] border border-[var(--card-border)] rounded-2xl shadow-2xl z-50">
            {/* Header */}
